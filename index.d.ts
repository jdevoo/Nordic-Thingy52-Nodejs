...
export declare class Thingy {
  ...
  disconnect(callback?: (err: Error | null) => void): Promise<void> | void;
  ...
  // GATT UUID constants
  static readonly TCS_UUID: string;
  static readonly TES_UUID: string;
  static readonly UIS_UUID: string;
  static readonly TMS_UUID: string;
  static readonly TSS_UUID: string;
  static readonly BATTERY_SVC_UUID: string;

  // Static discovery methods
  static discoverAll(callback: (thingy: Thingy) => void | Promise<void>): void;
  static discoverByAddress(
    address: string,
    callback: (thingy: Thingy) => void | Promise<void>,
  ): void;
